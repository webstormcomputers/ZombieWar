local z_chillaxin_speed = 2 --~ was 2
local z_animation_speed = 10 --~was15
local z_mesh = "creatures_mob.x"
local z_texture = {"creatures_heavy.png"}
local z_hp = 80
local z_drop = "creatures:rotten_flesh"
local z_life_max = 120 --~5min
...
creatures.z_spawn_nodes = {"default:dry_dirt","default:dirt","default:mossycobble", "default:stone","default:dirt","default:desert_sand","default:dirt_with_grass","default:dirt_with_ice","default:dirt_with_dry_grass","default:sand"}
creatures.z_spawner_range = 17
creatures.z_spawner_max_mobs = 1
...
function z_hit(self)
	...
	prop = {
		mesh = z_mesh,
		textures = {"creatures_heavy.png^creatures_heavy_hit.png"},
	}
...
ZOMBIE_DEF.on_step = function(self, dtime)
	...
	if nn ~= nil and nn == "default:water_source" or
	   ...
	   nn == "default:lava_flowing" 
	   
	   --(wtime > 0.2 and wtime < 0.805 and current_pos.y > 0 and ll > 11) 
	   then
...
minetest.register_entity("creatures:heavyz", ZOMBIE_DEF)
